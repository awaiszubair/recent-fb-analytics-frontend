      ...
      <div className="flex items-center gap-3 lg:gap-6 shrink-0">
        ...
        <div className="hidden sm:flex items-center gap-5 lg:gap-8">
          ...
          <div className="relative">
            <button onClick={() => setIsInfoOpen(!isInfoOpen)} className="flex items-center justify-center relative z-10" aria-label="Platform Information">
            ...
            {isInfoOpen && (
              <>
                <div className="fixed inset-0 z-20" onClick={() => setIsInfoOpen(false)} />
                <div className="absolute top-full right-0 mt-4 w-[320px] bg-[#1C1B1B] border border-[#2A2A2A] rounded-xl shadow-2xl p-5 z-30">
                  <h3 className="text-white text-[15px] font-bold mb-2 tracking-tight">About FB Analytics</h3>
                  <p className="text-[#9CA3AF] text-[13px] leading-relaxed mb-4">
                    FB Analytics is a powerful internal tool designed to aggregate, analyze, and visualize your Facebook Page insights and monetization earnings in real-time. It provides actionable metrics across all your connected pages.
                  </p>
                  <a href="mailto:ai-ops@publisherinabox.com?subject=Support%20Query" className="inline-flex items-center justify-center w-full bg-[#2A2A2A] hover:bg-[#3A3A3A] text-white text-[13px] font-semibold py-2.5 rounded-lg transition-colors">
                    Contact Support
                  </a>
                </div>
              </>
